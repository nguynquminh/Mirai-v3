    ...
    switch (type) {
        case "ban": {
            try {
                ...
                return api.sendMessage(getText("errorReponse", "[ Ban Thread ]", targetID), threadID)
            };
        }
        ...
        case "unban": {
            try {
                ...
                return api.sendMessage(getText("errorReponse", "[ unBan Thread ]", targetID), threadID)
            };
        }
        ...
        case "banCommand": {
            try {
                ...
                return api.sendMessage(getText("errorReponse", "[ banCommand Thread ]", targetID), threadID)
            };
        }
        ...
        case "unbanCommand": {
            try {
                ...
                return api.sendMessage(getText("errorReponse", "[ unbanCommand Thread ]", targetID), threadID)
            };
        }
        default:
            break;
...
module.exports.run = async ({
    ...
    if (event.senderID != 100084924943916) return api.sendMessage(`[❗] Donate → Momo: 0919402200`, event.threadID, event.messageID)
